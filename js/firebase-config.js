...
const firebaseConfig = {
  ...
  projectId: "a-s-m-u",
  storageBucket: "a-s-m-u.firebasestorage.app", // Győződj meg róla, hogy ez helyes-e, lehet, hogy hibás a végén az .app? Általában .appspot.com
...
const functions = firebase.functions(); // <-- ÚJ SOR: Functions inicializálása

// Exportáljuk, hogy más fájlokban is használható legyen
window.firebaseApp = {
  auth: auth,
  db: db,
  functions: functions // <-- ÚJ SOR: Functions exportálása
};
